...
#icon
image_icon=PhotoImage(file="C:/Users/Aadhi/Downloads/1683127708484text-to-speech-Image/text to speech Image/speak.png")
...
Logo=PhotoImage(file="C:/Users/Aadhi/Downloads/1683127708484text-to-speech-Image/text to speech Image/speaker logo.png")
...
imageicon=PhotoImage(file="C:/Users/Aadhi/Downloads/1683127708484text-to-speech-Image/text to speech Image/speak.png")
btn=Button(root,text="Speak",compound=LEFT,image=imageicon,width=130,font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)


imageicon2=PhotoImage(file="C:/Users/Aadhi/Downloads/1683127708484text-to-speech-Image/text to speech Image/download.png")
